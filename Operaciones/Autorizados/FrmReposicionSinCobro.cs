...
{
    public partial class FrmReposicionSinCobro : Form
    {
        public string Cargo;
        ...
        public FrmReposicionSinCobro(string documento, string cargo, long idEstacionamiento)
        {
            InitializeComponent();
            this.Cargo = cargo;
        ...
        private bool ObtenerValorParametrosPorNombre()
        {
            bool ok = false;
            string Codigo = "";
            string nombre = "claveTarjeta";
            Codigo = ParametrosController.ObtenerValorParametrosPorNombre(nombre,IdEstacionamiento);
                ...
                if (e.ColumnIndex == DvgListadoPersonasAutorizadas.Columns["Editar"].Index)
                {
                    ...
                    if (Convert.ToBoolean(ChkEditar.Value) == true)
                    {
                        if (Cargo == "ENCARGADO")
                        {
                            ...
                            txtIdTarjeta.Text = Convert.ToString(DvgListadoPersonasAutorizadas.CurrentRow.Cells["IdTarjeta"].Value);
        ...
        private void FrmReposicionSinCobro_Load(object sender, EventArgs e)
        {
